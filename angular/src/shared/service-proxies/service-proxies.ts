...
export class CarServiceProxy {
     ...
     * @return Success
     */
    getAllCars(): Observable<GetCarDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Car/GetAllCars";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetCarDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCarDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllCars(response: HttpResponseBase): Observable<GetCarDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetCarDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<GetCarDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    getCar(id: number | undefined): Observable<GetCarDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/GetCar?";
        if (id === null)
    ...
    protected processGetCar(response: HttpResponseBase): Observable<GetCarDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetCarDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    createCar(body: CreateCarDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Car/CreateCar";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateCar(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateCar(body: CarDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Car/UpdateCar";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteCar(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Car/DeleteCar?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCar(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    getCarsByCompany(id: number | undefined): Observable<GetCarDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Car/GetCarsByCompany?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCarsByCompany(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCarsByCompany(<any>response_);
                } catch (e) {
                    return <Observable<GetCarDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetCarsByCompany(response: HttpResponseBase): Observable<GetCarDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createFilteredQuery(body: PagedCarResultRequestDto | undefined): Observable<GetCarDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/CreateFilteredQuery";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetCarDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCarDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreateFilteredQuery(response: HttpResponseBase): Observable<GetCarDtoPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetCarDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetCarDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    uploadImage(body: Blob | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Car/UploadImage";
        url_ = url_.replace(/[?&]$/, "");
...
export class CompanyServiceProxy {
     ...
     * @return Success
     */
    getAllCompanies(): Observable<GetCompanyDto[]> {
    ...
    protected processGetAllCompanies(response: HttpResponseBase): Observable<GetCompanyDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getCompany(id: number | undefined): Observable<GetCompanyDto> {
        let url_ = this.baseUrl + "/api/services/app/Company/GetCompany?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
    ...
    protected processGetCompany(response: HttpResponseBase): Observable<GetCompanyDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createCompany(body: CreateCompanyDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    updateCompany(body: CompanyDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    deleteCompany(id: number | undefined): Observable<void> {
     ...
     * @return Success
     */
    createFilteredQuery(body: PagedCompanyResultRrequestDto | undefined): Observable<CompanyPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Company/CreateFilteredQuery";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CompanyPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CompanyPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreateFilteredQuery(response: HttpResponseBase): Observable<CompanyPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CompanyPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CompanyPagedResultDto>(<any>null);
    }

    /**
     * @return Success
     */
    getRandCompany(): Observable<Company> {
        let url_ = this.baseUrl + "/api/services/app/Company/GetRandCompany";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRandCompany(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRandCompany(<any>response_);
                } catch (e) {
    ...
    protected processGetRandCompany(response: HttpResponseBase): Observable<Company> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TransactionServiceProxy {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetTransactionDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetTransactionDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllTransactions(response: HttpResponseBase): Observable<GetTransactionDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GetTransactionDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<GetTransactionDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    getTransaction(id: number | undefined): Observable<GetTransactionDto> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/GetTransaction?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
    ...
    protected processGetTransaction(response: HttpResponseBase): Observable<GetTransactionDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetTransactionDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    createTransation(body: CreateTransactionDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/CreateTransation";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateTransation(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTransation(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateTransation(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateTransaction(body: TransactionDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/UpdateTransaction";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteTransaction(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/DeleteTransaction?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
     ...
     * @return Success
     */
    getTransactionsByCar(id: number | undefined): Observable<GetTransactionDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/GetTransactionsByCar?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTransactionsByCar(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTransactionsByCar(<any>response_);
                } catch (e) {
                    return <Observable<GetTransactionDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetTransactionsByCar(response: HttpResponseBase): Observable<GetTransactionDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TransactionDto implements ITransactionDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.buyDate = _data["buyDate"] ? moment(_data["buyDate"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["buyDate"] = this.buyDate ? this.buyDate.toISOString() : <any>undefined;
...
export class GetCarDto implements IGetCarDto {
    name: string | undefined;
    ...
    static fromJS(data: any): GetCarDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCarDto();
        result.init(data);
        return result;
    }
...
export class PagedCarResultRequestDto implements IPagedCarResultRequestDto {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;

    constructor(data?: IPagedCarResultRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedCarResultRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedCarResultRequestDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedCarResultRequestDto {
        const json = this.toJSON();
        let result = new PagedCarResultRequestDto();
        result.init(json);
        return result;
...
export interface IPagedCarResultRequestDto {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;
}

export class GetCarDtoPagedResultDto implements IGetCarDtoPagedResultDto {
    totalCount: number;
    items: GetCarDto[] | undefined;

    constructor(data?: IGetCarDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetCarDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): GetCarDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCarDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IGetCarDtoPagedResultDto {
    totalCount: number;
    items: GetCarDto[] | undefined;
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["cars"])) {
                ...
                for (let item of _data["cars"])
                    this.cars.push(GetCarDto.fromJS(item));
            }
            this.id = _data["id"];
        }
    }
...
export class PagedCompanyResultRrequestDto implements IPagedCompanyResultRrequestDto {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;

    constructor(data?: IPagedCompanyResultRrequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedCompanyResultRrequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedCompanyResultRrequestDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedCompanyResultRrequestDto {
        const json = this.toJSON();
        let result = new PagedCompanyResultRrequestDto();
        result.init(json);
        return result;
...
export interface IPagedCompanyResultRrequestDto {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;
}
...
export class CompanyPagedResultDto implements ICompanyPagedResultDto {
    totalCount: number;
    items: Company[] | undefined;

    constructor(data?: ICompanyPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
...
export interface ICompanyPagedResultDto {
    totalCount: number;
    items: Company[] | undefined;
}
...
export class GetTransactionDto implements IGetTransactionDto {
    ...
    constructor(data?: IGetTransactionDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetTransactionDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetTransactionDto();
        result.init(data);
        return result;
    }
