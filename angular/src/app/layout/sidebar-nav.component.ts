...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        new MenuItem(this.l('Car'), 'Pages.Cars', 'directions_car', '/app/car'),
        new MenuItem(this.l('Company'), 'Pages.Companies', 'business', '/app/company'),
        new MenuItem(this.l('Transaction'), '', 'description', '/app/transaction'),
